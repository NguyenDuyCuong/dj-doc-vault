...
ROOT_URLCONF = "dj_doc_vault.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "dj_doc_vault.context_processors.google_oauth_client_id",
                "dj_doc_vault.context_processors.stripe_publishable_key",
            ],
        },
    },
]

WSGI_APPLICATION = "dj_doc_vault.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "dj_doc_vault.permissions.IsConsumerAuthenticated",
...
AUTH_USER_MODEL = "dj_doc_vault_auth.User"
