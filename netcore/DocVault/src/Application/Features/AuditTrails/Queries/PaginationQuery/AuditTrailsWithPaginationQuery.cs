...
using DocVault.Application.Features.AuditTrails.Caching;
using DocVault.Application.Features.AuditTrails.DTOs;
using DocVault.Application.Features.AuditTrails.Specifications;

namespace DocVault.Application.Features.AuditTrails.Queries.PaginationQuery;
