...
using DocVault.Application.Features.Documents.Caching;
using DocVault.Application.Features.Documents.DTOs;
using DocVault.Application.Features.Documents.Specifications;

namespace DocVault.Application.Features.Documents.Queries.PaginationQuery;
