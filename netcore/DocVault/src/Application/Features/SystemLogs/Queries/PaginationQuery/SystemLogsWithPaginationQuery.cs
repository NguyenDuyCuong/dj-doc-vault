...
using DocVault.Application.Features.SystemLogs.Caching;
using DocVault.Application.Features.SystemLogs.DTOs;
using DocVault.Application.Features.SystemLogs.Specifications;
using Microsoft.Extensions.Logging;

namespace DocVault.Application.Features.SystemLogs.Queries.PaginationQuery;
