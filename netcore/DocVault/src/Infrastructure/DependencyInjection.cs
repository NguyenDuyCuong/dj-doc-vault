...
using DocVault.Application.Common.Interfaces.MediatorWrapper;
using DocVault.Application.Common.Interfaces.MultiTenant;
using DocVault.Application.Features.Fusion;
...
using DocVault.Infrastructure.Constants.Database;
using DocVault.Infrastructure.Constants.User;
using DocVault.Infrastructure.PermissionSet;
using DocVault.Infrastructure.Persistence.Interceptors;
using DocVault.Infrastructure.Services.Circuits;
using DocVault.Infrastructure.Services.MediatorWrapper;
using DocVault.Infrastructure.Services.MultiTenant;
using DocVault.Infrastructure.Services.Gemini;
...
public static class DependencyInjection
{
    ...
    private const string POSTGRESQL_MIGRATIONS_ASSEMBLY = "DocVault.Migrators.PostgreSQL";
    private const string MSSQL_MIGRATIONS_ASSEMBLY = "DocVault.Migrators.MSSQL";
    private const string SQLITE_MIGRATIONS_ASSEMBLY = "DocVault.Migrators.SqLite";
