...
namespace DocVault.Infrastructure.Extensions;
    ...
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        builder.Host.UseSerilog((context, configuration) =>
            configuration.ReadFrom.Configuration(context.Configuration)
                ...
                .MinimumLevel.Override("DocVault.Server.UI.Services.Fusion.UserSessionTracker", LogEventLevel.Error)
                .MinimumLevel.Override("DocVault.Server.UI.Services.Fusion.OnlineUserTracker", LogEventLevel.Error)
