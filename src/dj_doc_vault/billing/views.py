...
from dj_doc_vault.billing.forms import UpdateBillingInformationForm
from dj_doc_vault.model_loaders import get_stripe_customer_model
...
def billing_settings_view(request):
    ...
    if request.method == "POST":
        if form.is_valid():
            ...
            return redirect("dj_doc_vault-billing:billing-settings")
